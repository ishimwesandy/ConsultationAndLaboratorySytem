...
<li><a href="#" class="active">View Comments</a>
	<div id="sub-menu">
	<ul class="ul1">
	<li><a href="comment_vd.php" class="active">Doctor Comments</a></li>
	<li><a href="comment_vc.php">Customer Comments </a></li>
...
?>
		...
		<?php
include('connect.php');
$sql="SELECT *from comment where Usertype='user' order by datee";
